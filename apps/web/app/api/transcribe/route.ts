...
export async function POST(request: Request) {
  try {
    ...
    const currencyName = getCurrencyName(workspace?.currency ?? "AUD");
    ...
    whisperFormData.append(
      "prompt",
      `Transcribe this audio about cash expenses. Common items include groceries like eggs, rice, vegetables, meat, fruit. Amounts are in ${currencyName}s. For example: eggs twenty dollars, rice fifteen dollars.`
    );
